...
$x_renew_entry_icon_position_vertical   = x_coerce_value( x_get_option( 'x_renew_entry_icon_position_vertical' ), 'px' );
$x_renew_entry_icon_position_horizontal = x_coerce_value( x_get_option( 'x_renew_entry_icon_position_horizontal' ), '%' );
...
.x-main {
  width: calc(<?php echo $x_layout_content_width; ?> - 3.20197%);
}

.x-sidebar {
  width: calc(100% - 3.20197% - <?php echo $x_layout_content_width; ?>);
}
...
<?php if ( is_home() && $x_renew_entry_icon_position == 'creative' && x_get_option( 'x_blog_style' ) == 'standard'  ) : ?>
  ...
  @media (min-width: 979px) {
    ...
    .x-content-sidebar-active .entry-title:before {
      ...
      width: 70px;
      height: 70px;
      margin-top: -<?php echo $x_renew_entry_icon_position_vertical; ?>;
