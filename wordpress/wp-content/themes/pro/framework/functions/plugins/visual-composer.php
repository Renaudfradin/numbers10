...
if ( x_visual_composer_integration_on() ) :
  ...
  add_action( 'vc_backend_editor_enqueue_js_css', function() {
    wp_add_inline_style( 'js_composer', ".vc_element-icon.x-shortcode { background: none!important; display: flex; align-items: center; justify-content: center; } .vc_element-icon.x-shortcode:after { content: 'X'; font-style: normal; color: black; }" );
  } );
