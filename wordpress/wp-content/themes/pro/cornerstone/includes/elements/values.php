...
cs_define_values( 'toggle', cs_compose_values(
  ...
  cs_values( array(
    ...
    'anchor_text_primary_content'   => cs_value( '', 'all:html', true ),
    'anchor_text_secondary_content' => cs_value( '', 'all:html', true ),
...
cs_define_values( 'omega:looper-provider', array(
  ...
  'looper_provider_query_offset'         => cs_value( '', 'markup:raw' ),
  'looper_provider_query_include_sticky' => cs_value( false, 'markup:raw' ),

  // Taxonomu
  'looper_provider_tax'                  => cs_value( 'category', 'markup:raw' ), 
  'looper_provider_tax_hide_empty'       => cs_value( false, 'markup:raw' ),

  // Current Post Terms
  'looper_provider_terms_tax'            => cs_value( 'category', 'markup:raw' ), 
  
  // Custom / JSON
  'looper_provider_custom'               => cs_value( '', 'markup:raw' ),
  'looper_provider_json'                 => cs_value( '', 'markup:raw' ),
  'looper_provider_key_array'            => cs_value( '', 'markup:raw' ),

  // Array Generics
  'looper_provider_array_offset'         => cs_value( '', 'markup:raw' ),
...
cs_define_values( 'omega:looper-consumer', array(
  ...
  'looper_consumer_rewind'       => cs_value( false, 'markup:raw' ),
) );
