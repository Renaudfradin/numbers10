...
$values = cs_compose_values(
  array(
    ...
    'testimonial_margin'                        => cs_value( '!0em', 'style' ),
    'testimonial_padding'                       => cs_value( '!0em', 'style' ),
    'testimonial_border_width'                  => cs_value( '!0px', 'style' ),
    'testimonial_border_style'                  => cs_value( 'solid', 'style' ),
    'testimonial_border_color'                  => cs_value( 'transparent', 'style:color' ),
    'testimonial_border_radius'                 => cs_value( '!0px', 'style' ),
    ...
    'testimonial_content_margin'                => cs_value( '!0em', 'style' ),
    'testimonial_content_padding'               => cs_value( '!0em', 'style' ),
    'testimonial_content_border_width'          => cs_value( '!0px', 'style' ),
    'testimonial_content_border_style'          => cs_value( 'solid', 'style' ),
    'testimonial_content_border_color'          => cs_value( 'transparent', 'style:color' ),
    'testimonial_content_border_radius'         => cs_value( '!0px', 'style' ),
    ...
    'testimonial_cite_padding'                  => cs_value( '!0em', 'style' ),
    'testimonial_cite_border_width'             => cs_value( '!0px', 'style' ),
    'testimonial_cite_border_style'             => cs_value( 'solid', 'style' ),
    'testimonial_cite_border_color'             => cs_value( 'transparent', 'style:color' ),
    'testimonial_cite_border_radius'            => cs_value( '!0px', 'style' ),
  ...
  cs_values( array(
    'rating'                 => cs_value( false, 'all' ),
    'rating_base_font_size'  => cs_value( '0.8em', 'style' ),
    'rating_width'           => cs_value( '100%', 'style' ),
