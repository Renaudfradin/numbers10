...
$values = cs_compose_values(
  array(
    ...
    'quote_margin'                      => cs_value( '!0em', 'style' ),
    'quote_padding'                     => cs_value( '!0em', 'style' ),
    'quote_border_width'                => cs_value( '!0px', 'style' ),
    'quote_border_style'                => cs_value( 'solid', 'style' ),
    'quote_border_color'                => cs_value( 'transparent', 'style:color' ),
    'quote_border_radius'               => cs_value( '!0px', 'style' ),
    ...
    'quote_marks_graphic_opening_align' => cs_value( 'flex-start', 'style' ),
    'quote_marks_graphic_closing_align' => cs_value( 'flex-start', 'style' ),
  ),
  ...
  array(
    ...
    'quote_cite_padding'                => cs_value( '!0em', 'style' ),
    'quote_cite_border_width'           => cs_value( '!0px', 'style' ),
    'quote_cite_border_style'           => cs_value( 'solid', 'style' ),
    'quote_cite_border_color'           => cs_value( 'transparent', 'style:color' ),
    'quote_cite_border_radius'          => cs_value( '!0px', 'style' ),
