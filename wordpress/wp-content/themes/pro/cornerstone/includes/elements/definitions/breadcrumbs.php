...
$values = cs_compose_values(
  array(
    ...
    'breadcrumbs_border_style'                     => cs_value( 'solid', 'style' ),
    'breadcrumbs_border_color'                     => cs_value( 'transparent', 'style:color' ),
    'breadcrumbs_border_radius'                    => cs_value( '!0px', 'style' ),
    ...
    'breadcrumbs_links_border_radius'              => cs_value( '!0px', 'style' ),
