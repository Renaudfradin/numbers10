...
$values = cs_compose_values(
  array(
    ...
    'countdown_border_style'                     => cs_value( 'solid', 'style' ),
    'countdown_border_color'                     => cs_value( 'transparent', 'style:color' ),
    'countdown_border_radius'                    => cs_value( '!0px', 'style' ),
    ...
    'countdown_unit_border_style'                => cs_value( 'solid', 'style' ),
    'countdown_unit_border_color'                => cs_value( 'transparent', 'style:color' ),
    'countdown_unit_border_radius'               => cs_value( '!0px', 'style' ),
    ...
    'countdown_number_border_style'              => cs_value( 'solid', 'style' ),
    'countdown_number_border_color'              => cs_value( 'transparent', 'style:color' ),
    'countdown_number_border_radius'             => cs_value( '!0px', 'style' ),
    ...
    'countdown_digit_border_style'               => cs_value( 'solid', 'style' ),
    'countdown_digit_border_color'               => cs_value( 'transparent', 'style:color' ),
    'countdown_digit_border_radius'              => cs_value( '!0px', 'style' ),
