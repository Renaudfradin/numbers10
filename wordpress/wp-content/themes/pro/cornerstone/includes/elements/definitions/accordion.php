...
$values = cs_compose_values(
  array(
    ...
    'accordion_margin'                          => cs_value( '!0em', 'style' ),
    'accordion_padding'                         => cs_value( '!0em', 'style' ),
    'accordion_border_width'                    => cs_value( '!0px', 'style' ),
    'accordion_border_style'                    => cs_value( 'solid', 'style' ),
    'accordion_border_color'                    => cs_value( 'transparent', 'style:color' ),
    'accordion_border_radius'                   => cs_value( '!0px', 'style' ),
    ...
    'accordion_item_padding'                    => cs_value( '!0em', 'style' ),
    'accordion_item_border_width'               => cs_value( '!0px', 'style' ),
    'accordion_item_border_style'               => cs_value( 'solid', 'style' ),
    ...
    'accordion_header_border_radius'            => cs_value( '!0px', 'style' ),
    ...
    'accordion_content_margin'                  => cs_value( '!0em', 'style' ),
    ...
    'accordion_content_border_radius'           => cs_value( '!0px', 'style' ),
  ...
  return cs_compose_controls(
    array(
      'controls' => array(
        ...
        cs_control( 'box-shadow', 'accordion_content', $settings_accordion_content_text ),
...
cs_register_element( 'accordion', [
  ...
  'icon'    => 'native',
  'options' => [
    'valid_children'   => [ 'accordion-item' ],
    'add_new_element'  => [ '_type' => 'accordion-item' ],
    'default_children' => [
      [ '_type' => 'accordion-item', 'accordion_item_header_content' => __( 'Accordion Item 1', '__x__' ) ],
      [ '_type' => 'accordion-item', 'accordion_item_header_content' => __( 'Accordion Item 2', '__x__' ) ],
    ]
  ]
] );
