...
class Cornerstone_Front_End extends Cornerstone_Plugin_Component {
    ...
    add_action( 'wp_footer', array( $this, 'ensure_footer') ); // Needed for preview
  ...
  public function register_scripts() {
	...
	public function postLoaded() {
		...
		add_action( 'x_head_css', array( $this, 'output_generated_styles'), 12 );
  ...
  /**
	...
	public function ensure_footer() {

		if ( ! did_action( 'x_before_site_end' ) ) {
			cs_theme_integration_footer();
		}
